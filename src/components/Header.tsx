...
export default function Header() {
  ...
  return (
    <>
      ...
      <header
        className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled || isMenuOpen || isHovering
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="relative group z-50">
            ...
            >
              <Image src="/logo_lasownia_pic_white.png" alt="Lasownia" width={36} height={36} className="w-10 h-10" unoptimized />
            </Link>
